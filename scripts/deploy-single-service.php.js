/**
 * Скрипт для деплоя single-service.php на сервер
 */
...
async function deploySingleService() {
  try {
    ...
    const localFile = path.join(__dirname, '..', 'wp-theme', 'single-service.php');
    const remoteFile = deployConfig.remote.themePath + '/single-service.php';
