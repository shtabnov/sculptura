/**
 * Скрипт для деплоя front-page.php на сервер
 */
...
async function deployFrontPage() {
    try {
        ...
        const localFile = path.join(__dirname, "..", "wp-theme", "front-page.php");
        const remoteFile = deployConfig.remote.themePath + "/front-page.php";
